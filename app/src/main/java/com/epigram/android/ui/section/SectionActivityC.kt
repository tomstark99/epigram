...
class SectionActivityC : BaseActivity<SectionMvp.Presenter>(), SectionMvp.View, LoadNextPage {
    ...
    companion object {
        ...
        fun start(context: Activity, section: String, tag: String) {
            val intent = Intent(context, SectionActivityC::class.java)
