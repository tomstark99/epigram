...
class AdapterAuthor(tags: Pair<List<String>?, List<String>?>) :
    RecyclerView.Adapter<AdapterAuthor.MyViewHolder>() {
...
//    }
    ...
    override fun onViewAttachedToWindow(holder: MyViewHolder) {
        ...
        holder.disposable = RxView.clicks(holder.linearLayout)
            ...
            .subscribe { empty ->
                AuthorActivity.start(context as Activity, tags[holder.adapterPosition], slugs[holder.adapterPosition])
            }
    }
