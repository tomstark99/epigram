...
class AdapterArticles(context: Context, posts: MutableList<Post>, loadNext: LoadNextPage, position: Int) : RecyclerView.Adapter<AdapterArticles.MyViewHolder>(){
    ...
    enum class PageIndex(val id: Int, val pageNum: Int ,@LayoutRes val element: Int){
        ELEMENT_ARTICLE_B(0, 0, R.layout.element_news_article_breaking),
        ELEMENT_ARTICLE_F(1, 100, R.layout.element_news_article_first),
        ELEMENT_ARTICLE_N(2, 0, R.layout.element_news_article)
    }
